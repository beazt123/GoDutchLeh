...
public class MembersAdapter extends RecyclerView.Adapter<MembersAdapter.ViewHolder> {
  ...
  public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
    ...
    // in final implementation, each member should have their own photo but for now we use a random
    // one
    int randomImageId =
        random.nextInt(11); // pick a random image Id from the list of default images
